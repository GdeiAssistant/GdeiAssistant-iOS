...
本指南用于维护 iOS 客户端的 README、关于页、协议页、隐私说明、校园凭证说明、系统权限说明以及其他面向用户展示的公开文案。公开文案应写给真实用户阅读，不应写成 AI 提示词、内部草稿或评审说明。

## 应当说明的内容

- 用户权利、用户义务和功能限制。
- 隐私处理、敏感信息处理、Keychain 使用边界和账户安全提示。
- 校园账号凭证的授权、使用范围、撤回授权、删除申请和快速认证控制。
- iOS 权限用途、第三方服务使用范围和必要风险提示。
- 二手、跑腿、表白墙、失物招领等用户内容和交易场景的风险说明。
...
- 面向普通用户展示的调试账号、测试密码、Token、证书、签名文件或本地环境信息。
